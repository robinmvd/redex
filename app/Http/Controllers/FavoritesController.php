...
class FavoritesController extends Controller
{
    ...
    public function index()
    {
        ...
        $favorites = $user->favorites()
            // gebruik pivot table's created_at column om te sorteren.
    ...
    public function update(Book $book)
    {
        ...
        //->favorites() geeft een BelongsToMany relatie terug
        // hierdoor kan ik de ->attach() method gebruiken.
    ...
    public function destroy(Book $book)
    {
        ...
        //->favorites() geeft een BelongsToMany relatie terug
        // hierdoor kan ik de ->detach() method gebruiken.
